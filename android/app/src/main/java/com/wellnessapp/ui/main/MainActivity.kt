...
import com.wellnessapp.ui.main.fragments.ProfileFragment
...
class MainActivity : AppCompatActivity() {
    ...
    /**
     * Public entry point for child fragments to switch to the Settings page.
     */
    fun showSettings() {
        showTab(R.id.action_settings)
    }
    ...
    private fun updateMainTitle(itemId: Int) {
        ...
        // Only show top-bar settings button when on the Chat tab
        binding.btnSettings.visibility = if (itemId == R.id.action_chat) View.VISIBLE else View.GONE
    }
